 ...
 *
 * Modified by Hans-Åke Lund for Whitesmiths compiler 2024
 */
...
#define ZRQINIT 0     /* request receive init (s->r) */
#define ZRINIT 1      /* receive init (r->s) */
#define ZSINIT 2      /* send init sequence (optional) (s->r) */
#define ZACK 3        /* ack to ZRQINIT ZRINIT or ZSINIT (s<->r) */
#define ZFILE 4       /* file name (s->r) */
#define ZSKIP 5       /* skip this file (r->s) */
#define ZNAK 6        /* last packet was corrupted (?) */
#define ZABORT 7      /* abort batch transfers (?) */
#define ZFIN 8        /* finish session (s<->r) */
#define ZRPOS 9       /* resume data transmission here (r->s) */
#define ZDATA 10      /* data packet(s) follow (s->r) */
#define ZEOF 11       /* end of file reached (s->r) */
#define ZFERR 12      /* fatal read or write error detected (?) */
#define ZCRC 13       /* request for file CRC and response (?) */
#define ZCHALLENGE 14 /* security challenge (r->s) */
#define ZCOMPL 15     /* request is complete (?) */
#define ZCAN 16       /* pseudo frame;  other end cancelled session with 5* CAN */
#define ZFREECNT 17   /* request free bytes on file system (s->r) */
#define ZCOMMAND 18   /* issue command (s->r) */
#define ZSTDERR 19    /* output data to stderr (??) */
